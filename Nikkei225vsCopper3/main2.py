...
plt.plot(copper_closex80.index, copper_closex80, label='Copper Close x 80')
...
plt.savefig("./Nikkei225vsCopper3/copperx80vsNikkei225USdollar-1.png")

# グラフ化
plt.scatter(copper_closex80, dollar_nikkei_close)
plt.xlabel("Copper Close x 80 Price")
...
plt.savefig("./Nikkei225vsCopper3/copperx80vsNikkei225USdollar-2.png")
