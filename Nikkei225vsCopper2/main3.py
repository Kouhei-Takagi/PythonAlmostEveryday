...
# 銅価格を4乗に正規化
copper_closePow4 = copper_close ** 4

# データをプロット
plt.figure(figsize=(14,8))
plt.plot(copper_closePow4.index, copper_closePow4, label='Copper Close Pow 4')
plt.plot(dollar_nikkei_close.index, dollar_nikkei_close, label='Nikkei Close (USD)')

plt.title('Copper Pow 4 vs Nikkei (in USD)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()

# Save the figure as a PNG file
plt.savefig("./Nikkei225vsCopper2/copperPow4vsNikkei225USdollar.png")
