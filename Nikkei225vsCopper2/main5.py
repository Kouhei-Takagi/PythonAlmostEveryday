...
class MarketAnalysis:
    ...
    def fetch_data(self):
        ...
        self.copper_closePow3 = self.copper_close ** 3

    def plot_data(self, filename):
        plt.figure(figsize=(14,8))
        plt.plot(self.copper_closePow3.index, self.copper_closePow3, label='Copper Close Pow 3')
...
# Use the class
analysis = MarketAnalysis("2015-01-01", "2023-06-02")
analysis.fetch_data()
analysis.plot_data("./Nikkei225vsCopper2/copperPow3vsNikkei225USdollar2.png")
