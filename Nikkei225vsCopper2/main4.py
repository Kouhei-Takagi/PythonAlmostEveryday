...
# 銅価格を3乗し、7倍して正規化
copper_closePow3x7 = (copper_close ** 3) * 7

# データをプロット
plt.figure(figsize=(14,8))
plt.plot(copper_closePow3x7.index, copper_closePow3x7, label='Copper Close Pow 3 x 7')
plt.plot(dollar_nikkei_close.index, dollar_nikkei_close, label='Nikkei Close (USD)')

plt.title('Copper Pow 3 x 7 vs Nikkei (in USD)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()

# Save the figure as a PNG file
plt.savefig("./Nikkei225vsCopper2/copperPow3x7vsNikkei225USdollar.png")
