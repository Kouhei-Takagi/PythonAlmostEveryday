...
# 銅価格を150倍に正規化
copper_closex150 = copper_close * 150

# データをプロット
plt.figure(figsize=(14,8))
plt.plot(copper_closex150.index, copper_closex150, label='Copper Close x 150')
plt.plot(dollar_nikkei_close.index, dollar_nikkei_close, label='Nikkei Close (USD)')

plt.title('Copper x 150 vs Nikkei (in USD)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()

# Save the figure as a PNG file
plt.savefig("./Nikkei225vsCopper/copperx150vsNikkei225USdollar.png")
