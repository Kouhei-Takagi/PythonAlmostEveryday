...
# 銅価格を200倍に正規化
copper_closex200 = copper_close * 200

# データをプロット
plt.figure(figsize=(14,8))
plt.plot(copper_closex200.index, copper_closex200, label='Copper Close x 200')
plt.plot(dollar_nikkei_close.index, dollar_nikkei_close, label='Nikkei Close (USD)')

plt.title('Copper x 200 vs Nikkei (in USD)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()

# Save the figure as a PNG file
plt.savefig("./Nikkei225vsCopper/copperx200vsNikkei225USdollar.png")
