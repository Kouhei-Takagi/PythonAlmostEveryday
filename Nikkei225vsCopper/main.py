...
# 銅価格を100倍に正規化
copper_closex100 = copper_close * 100

# データをプロット
plt.figure(figsize=(14,8))
plt.plot(copper_closex100.index, copper_closex100, label='Copper Close x 100')
plt.plot(dollar_nikkei_close.index, dollar_nikkei_close, label='Nikkei Close (USD)')

plt.title('Copper x 100 vs Nikkei (in USD)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()

# Save the figure as a PNG file
plt.savefig("./Nikkei225vsCopper/copperx100vsNikkei225USdollar.png")
